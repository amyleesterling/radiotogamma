...
window.SPECTRUM_DATA = (() => {
  ...
  const LANDMARKS = [
    ...
    { id: 'separator-gold', name: 'Separator, gold band', cat: 'dust off',
      ...
      how: 'A crossover from the Separator game, built on the radiofrequency particle separator patent: particles of a given size respond most strongly to a matching radio frequency, and for 1.6 mm gold grains that tuning lands near 18 MHz.' },
